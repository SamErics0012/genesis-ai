  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await signUp.email({
        email,
        password,
        name: displayName || email.split('@')[0], // Use full name or email prefix
      }, {
        onSuccess: async (ctx) => {
      ...
      <div className="flex w-full lg:w-[30%] items-center justify-center bg-black p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <p className="text-center text-xs text-zinc-400">
            By clicking the "Sign up" button, you are creating a Genesis AI account and therefore you agree to Genesis AI{" "}
