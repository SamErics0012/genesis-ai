...
const testimonials: Testimonial[] = [
  {
    ...
    role: "Digital Artist",
    message:
      "Genesis AI has completely transformed my workflow. I can now generate high-quality concept art in minutes instead of days. The consistency is unmatched.",
  ...
  },
  {
    ...
    role: "Filmmaker",
    message:
      "The video generation capabilities are mind-blowing. I used it to create background elements for my short film and nobody could tell it was AI.",
  ...
  },
  {
    ...
    message:
      "As a solo creator, this tool is a lifesaver. I can produce high-quality video content for my channel without a big budget or team.",
